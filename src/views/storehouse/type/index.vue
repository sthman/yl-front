<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['storehouse:type:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['storehouse:type:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['storehouse:type:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['storehouse:type:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="物品类型id，主键，自增" align="center" prop="itemTypeId" />
...
<script>
import { listType, getType, delType, addType, updateType } from "@/api/storehouse/type";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getType(itemTypeId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除物品类型编号为"' + itemTypeIds + '"的数据项？').then(function() {
        return delType(itemTypeIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('storehouse/type/export', {
        ...this.queryParams
