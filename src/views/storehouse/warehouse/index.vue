<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="所属机构id，外键" prop="orgId">
        <el-input
          v-model="queryParams.orgId"
          placeholder="请输入所属机构id，外键"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="仓库类型id，外键" prop="warehouseTypeId">
        <el-input
          v-model="queryParams.warehouseTypeId"
          placeholder="请输入仓库类型id，外键"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="warehouseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="仓库id，主键，自增" align="center" prop="warehouseId" />
      <el-table-column label="所属机构id，外键" align="center" prop="orgId" />
      <el-table-column label="仓库类型id，外键" align="center" prop="warehouseTypeId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="所属机构id，外键" prop="orgId">
          <el-input v-model="form.orgId" placeholder="请输入所属机构id，外键" />
        </el-form-item>
        <el-form-item label="仓库类型id，外键" prop="warehouseTypeId">
          <el-input v-model="form.warehouseTypeId" placeholder="请输入仓库类型id，外键" />
        </el-form-item>
        <el-form-item label="备用列1" prop="beiyong1">
...
<script>
import { listWarehouse, getWarehouse, delWarehouse, addWarehouse, updateWarehouse } from "@/api/storehouse/warehouse";
