<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="物品类型id，外键" prop="itemTypeId">
        <el-input
          v-model="queryParams.itemTypeId"
          placeholder="请输入物品类型id，外键"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['storehouse:item:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['storehouse:item:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['storehouse:item:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['storehouse:item:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="itemList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="物品id，主键，自增" align="center" prop="itemId" />
      <el-table-column label="物品名称" align="center" prop="itemName" />
      <el-table-column label="数量" align="center" prop="quantity" />
      <el-table-column label="物品类型id，外键" align="center" prop="itemTypeId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="物品类型id，外键" prop="itemTypeId">
          <el-input v-model="form.itemTypeId" placeholder="请输入物品类型id，外键" />
        </el-form-item>
        <el-form-item label="备用列1" prop="beiyong1">
...
<script>
import { listItem, getItem, delItem, addItem, updateItem } from "@/api/storehouse/item";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('storehouse/item/export', {
        ...this.queryParams
