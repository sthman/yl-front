<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="银行负责人" prop="bankHead">
        <el-input
          v-model="queryParams.bankHead"
          placeholder="请输入银行负责人"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="银行对公账户" prop="bankPublicAccount">
        <el-input
          v-model="queryParams.bankPublicAccount"
          placeholder="请输入银行对公账户"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="bankList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="银行负责人" align="center" prop="bankHead" />
      <el-table-column label="银行地址" align="center" prop="bankAddress" />
      <el-table-column label="银行对公账户" align="center" prop="bankPublicAccount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="银行负责人" prop="bankHead">
          <el-input v-model="form.bankHead" placeholder="请输入银行负责人" />
        </el-form-item>
        <el-form-item label="银行地址" prop="bankAddress">
          <el-input v-model="form.bankAddress" placeholder="请输入银行地址" />
        </el-form-item>
        <el-form-item label="银行对公账户" prop="bankPublicAccount">
          <el-input v-model="form.bankPublicAccount" placeholder="请输入银行对公账户" />
        </el-form-item>
        <el-form-item label="备用列1" prop="beiyong1">
...
<script>
import { listBank, getBank, delBank, addBank, updateBank } from "@/api/bank/bank";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除银行信息编号为"' + bankIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('bank/bank/export', {
        ...this.queryParams
