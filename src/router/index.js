  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/government/category/index'),
      },
      {
        path: '/government/older',
        component: () => import('@/views/government/older/index'),
      },
      {
        path: '/government/type',
        component: () => import('@/views/government/type/index'),
      },
      {
        path: '/organization/bed',
        component: () => import('@/views/organization/bed/index'),
      },
      {
      ...
      {
        path: '/organization/organizationtype',
        component: () => import('@/views/organization/organizationtype/index'),
      },
      {
